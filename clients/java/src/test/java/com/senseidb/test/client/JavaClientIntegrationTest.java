...
public class JavaClientIntegrationTest extends Assert {
  ...
  public void testSelectionRange() throws Exception {
    ...
    // (2000 TO 2002] ==> 2907
    // [2000 TO 2002) ==> 2991
    SenseiClientRequest request = SenseiClientRequest.builder()
        .addSelection(Selection.range("year", "2000", "2002")).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("numhits is wrong", 4455, res.getNumhits().intValue());

    request = SenseiClientRequest.builder()
        .addSelection(Selection.range("year", "2000", "2002", false, false)).build();
    res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("numhits is wrong", 1443, res.getNumhits().intValue());

    request = SenseiClientRequest.builder()
        .addSelection(Selection.range("year", "2000", "2002", false, true)).build();
    res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("numhits is wrong", 2907, res.getNumhits().intValue());

    request = SenseiClientRequest.builder()
        .addSelection(Selection.range("year", "2000", "2002", true, false)).build();
    res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testMatchAllWithBoostQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder().query(Queries.matchAllQuery(1.2))
        .build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testQueryStringQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.stringQuery("red AND cool")).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testUIDQueryRaw() throws Exception {
    ...
    JSONObject res = new JSONObject(senseiServiceProxy.sendPostRaw(
      senseiServiceProxy.getSearchUrl(), req));
    assertEquals("numhits is wrong", 2, res.getInt("numhits"));
    assertEquals("the first uid is wrong", 1,
      res.getJSONArray("hits").getJSONObject(0).getInt("uid"));
    assertEquals("the second uid is wrong", 3,
      res.getJSONArray("hits").getJSONObject(1).getInt("uid"));
  }

  @Test
  public void testUIDQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.ids(Arrays.asList("1", "2", "3"), Arrays.asList("2"), 1.0)).build();
  ...
  public void testTextQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.textQuery("contents", "red cool", Operator.and, 1.0)).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("numhits is wrong", 1070, res.getNumhits().intValue());
  ...
  public void testTermQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.term("color", "red", 1.0)).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testTermsQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.terms("tags", Arrays.asList("leather", "moon-roof"), Arrays.asList("hybrid"),
            Operator.or, 0, 1.0)).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testBooleanQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.bool(Arrays.asList((Query) Queries.term("color", "red", 1.0)),
            Arrays.asList((Query) Queries.term("category", "compact", 1.0)), null, 1.0)).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testDisMaxQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.disMax(0.7, 1.2, Queries.term("color", "red", 1.0),
            Queries.term("color", "blue", 1.0))
  ...
  public void testPathQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.path("makemodel", "asian/acura/3.2tl", 1.0)
  ...
  public void testPrefixQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.prefix("color", "blu", 2.0)
  ...
  public void testWildcardQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.wildcard("color", "bl*e", 2.0)
  ...
  public void testRangeQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.range("year", "1999", "2000", true, true, 2.0, false)
  ...
  public void testRangeQuery2() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.range("year", "1999", "2000", true, true, 2.0, false, "int")
  ...
  public void testFilteredQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.filteredQuery(Queries.term("color", "red", 1.0),
            Filters.range("year", "1999", "2000"), 1.0)
  ...
  public void testSpanTermQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.spanTerm("color", "red", 1.0)
  ...
  public void testSpanOrQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.spanOr(1.0, Queries.spanTerm("color", "red", 1.0),
            Queries.spanTerm("color", "blue"))
  ...
  public void testSpanNotQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .query(
          Queries.spanNot(Queries.spanTerm("contents", "compact", 1.0),
            Queries.spanTerm("contents", "red", 1.0), 1.0)
  ...
  public void testSpanNearQuery1() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        ...
        .query(
          Queries.spanNear(
            Arrays.asList(Queries.spanTerm("contents", "red"),
              Queries.spanTerm("contents", "compact"), Queries.spanTerm("contents", "hybrid")), 12,
            false, false, 1.0)
  ...
  public void testSpanNearQuery2() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        ...
        .query(
          Queries.spanNear(
            Arrays.asList(Queries.spanTerm("contents", "red"),
              Queries.spanTerm("contents", "compact"), Queries.spanTerm("contents", "favorite")),
            0, true, false, 1.0)
  ...
  public void testSpanFirstQuery() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .query(Queries.spanFirst(Queries.spanTerm("color", "red"), 2, 1.0)
  ...
  public void testUIDFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .filter(Filters.ids(Arrays.asList("1", "2", "3"), Arrays.asList("2"))).build();
  ...
  public void testAndFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .filter(Filters.and(Filters.term("tags", "mp3"), Filters.term("color", "red"))
  ...
  public void testOrFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .filter(Filters.or(Filters.term("color", "blue"), Filters.term("color", "red"))
  ...
  public void testBooleanFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .filter(
          Filters.bool(Arrays.asList((Filter) Filters.term("color", "red")),
            Arrays.asList((Filter) Filters.term("category", "compact")),
            Arrays.asList((Filter) Filters.term("color", "red")))).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("numhits is wrong", 1652, res.getNumhits().intValue());
  ...
  public void testQueryFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .filter(Filters.query(Queries.range("year", "1999", "2000", true, true, 1.0, false))
  ...
  public void testTermFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder().filter(Filters.term("color", "red")
  ...
  public void testTermsFilter() throws Exception {
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .filter(
          Filters.terms("tags", Arrays.asList("leather", "moon-roof"), Arrays.asList("hybrid"),
            Operator.or)
  ...
  public void testTemplateMapping() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder()
        .filter(Filters.range("year", "$from", "$to")

        ).explain(true).addTemplateMapping("from", "1999").addTemplateMapping("to", "2000").build();
    System.out.println(JsonSerializer.serialize(request));
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
  ...
  public void testRelevance() throws Exception {
    Model model = Model
        .builder()
        .addFacets(RelevanceFacetType.type_int, "year", "mileage")
        .addFacets(RelevanceFacetType.type_long, "groupid")
        .addFacets(RelevanceFacetType.type_string, "color", "category")
        .addFunctionParams("_INNER_SCORE", "thisYear", "year", "goodYear", "mileageWeight",
          "mileage", "color", "yearcolor", "colorweight", "category", "categorycolor")
        .addVariables(VariableType.set_int, "goodYear")
        .addVariables(VariableType.type_int, "thisYear")
        .addVariables(VariableType.map_int_float, "mileageWeight")
        .addVariables(VariableType.map_int_string, "yearcolor")
        .addVariables(VariableType.map_string_float, "colorweight")
        .addVariables(VariableType.map_string_string, "categorycolor")
        .saveAs("model", true)
        .function(
          " if(categorycolor.containsKey(category) && categorycolor.get(category).equals(color))  return 10000f; if(colorweight.containsKey(color) ) return 200f + colorweight.getFloat(color); if(yearcolor.containsKey(year) && yearcolor.get(year).equals(color)) return 200f; if(mileageWeight.containsKey(mileage)) return 10000+mileageWeight.get(mileage); if(goodYear.contains(year)) return (float)Math.exp(2d);   if(year==thisYear) return 87f   ; return  _INNER_SCORE;")
        .build();
    Map<Object, Object> map = new HashMap<Object, Object>();
    map.put("red", 335.5);
    RelevanceValues.RelevanceValuesBuilder valuesBuilder = new RelevanceValues.RelevanceValuesBuilder()
        .addAtomicValue("thisYear", 2001).addListValue("goodYear", 1996, 1997)
    ...
    SenseiClientRequest request = SenseiClientRequest
        .builder()
        .addSort(Sort.byRelevance())
        .query(
          Queries.stringQuery("").setRelevance(Relevance.valueOf(model, valuesBuilder.build())))
        .build();
  ...
  public void testError() throws Exception {
    ...
    assertEquals("[line:1, col:0] No viable alternative (token=select1)", res.getErrors().get(0)
        .getMessage());
  ...
  public void testMapReduce() throws Exception {
    SenseiResult res = senseiServiceProxy.sendSearchRequest(Examples.mapReduce(
      SenseiClientRequest.builder()).build());
  ...
  public void testFetchStoredFields() throws Exception {
    SenseiClientRequest request = SenseiClientRequest.builder().query(Queries.matchAllQuery(1))
        .setFieldsToFetch(Arrays.asList("color")).build();
    SenseiResult res = senseiServiceProxy.sendSearchRequest(request);
    assertEquals("number of return stored fields is wrong", 1, res.getHits().get(0)
        .getStoredFields().size());
    assertEquals("numhits is wrong", 15000, res.getNumhits().intValue());
  }
  ...
  // String req =
  // "{\"filter\":{\"and\":[{\"term\":{\"color\":\"blue\",\"_noOptimize\":false}},{\"query\":{\"term\":{\"category\":\"compact\"}}}]}}";
  ...
  /*
   * In the following two test cases, when modifying the first one by changing "tags" to "tag", it
   * is supposed that Only the first test case is not correct, but the second one also throw one
   * NPE, which is weird.
   */
  ...
  // String req =
  // "{\"filter\":{\"and\":[{\"term\":{\"tags\":\"mp3\",\"_noOptimize\":false}},{\"query\":{\"term\":{\"color\":\"red\"}}}]}}";
  // JSONObject res = search(new JSONObject(req));
  ...
  // String req =
  // "{\"filter\":{\"or\":[{\"term\":{\"color\":\"blue\",\"_noOptimize\":false}},{\"query\":{\"term\":{\"color\":\"red\"}}}]}}";
  // JSONObject res = search(new JSONObject(req));
  // assertEquals("numhits is wrong", 3264, res.getInt("numhits"));
  // }
