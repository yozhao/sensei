...
public class Test {
  public static void main(String[] args) throws Exception {
    ...
    JSONObject mapReduce = new JSONObject().put("function", "sensei.distinctCount").put(
      "parameters", new JSONObject().put("column", "account_id"));
    json.put("mapReduce", mapReduce);
    System.out.println(new JSONObject(senseiServiceProxy.sendPostRaw(
      senseiServiceProxy.getSearchUrl(), json.toString())).toString(1));
  }
}
