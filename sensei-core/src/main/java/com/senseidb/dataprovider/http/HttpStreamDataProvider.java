...
public abstract class HttpStreamDataProvider<D> extends StreamDataProvider<D> implements
  ...
  public HttpStreamDataProvider(Comparator<String> versionComparator, String baseUrl, String pw,
      int fetchSize, String startingOffset, boolean disableHttps) {
    ...
    params.setIntParameter(HttpConnectionParams.SOCKET_BUFFER_SIZE, 1024 * 1024); // 1mb socket
                                                                                  // buffer
