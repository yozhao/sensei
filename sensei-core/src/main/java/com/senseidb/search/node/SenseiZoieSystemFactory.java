...
public class SenseiZoieSystemFactory<T> extends SenseiZoieFactory<T> {
  ...
  private final Map<Integer, IndexingMetrics> metricsMap = new HashMap<Integer, IndexingMetrics>();

  public SenseiZoieSystemFactory(File idxDir, DIRECTORY_MODE dirMode,
  ...
  @Override
  public ZoieSystem<BoboSegmentReader, T> getZoieInstance(int nodeId, final int partitionId) {
