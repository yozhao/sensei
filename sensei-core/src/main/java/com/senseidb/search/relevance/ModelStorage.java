...
public class ModelStorage {
  ...
  public static boolean hasRuntimeModel(String modelName) {
    if (runtimeCRFMap.containsKey(modelName)) return true;
    else return false;
  }

  public static boolean hasPreloadedModel(String modelName) {
    if (preloadedCRFMap.containsKey(modelName)) return true;
    else return false;
  }

  public static RuntimeRelevanceFunctionFactory getRuntimeModel(String modelName) {
    if (runtimeCRFMap.containsKey(modelName)) return runtimeCRFMap.get(modelName);
    else return null;
  }

  public static CustomRelevanceFunctionFactory getPreloadedModel(String modelName) {
    if (preloadedCRFMap.containsKey(modelName)) return preloadedCRFMap.get(modelName);
    else return null;
  }
