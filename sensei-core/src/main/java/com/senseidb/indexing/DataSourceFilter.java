...
public abstract class DataSourceFilter<D> {
  ...
  public JSONObject filter(D data) throws Exception {
    ...
    if (data != null && obj != null && !obj.has(_srcDataField) && _srcDataStore != null
        && _srcDataStore.length() != 0 && !"none".equals(_srcDataStore) && _srcDataField != null
        && _srcDataField.length() != 0) {
