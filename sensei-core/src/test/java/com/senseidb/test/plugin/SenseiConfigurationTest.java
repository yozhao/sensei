...
public class SenseiConfigurationTest extends Assert {
  ...
  public void setUp() throws Exception {
    ...
    configuration.load(getClass().getClassLoader().getResource(
      "refactored-configuration/sensei.properties"));
  ...
  public void test5GetEmptyBeanList() {
    List<Object> beans = pluginRegistry.resolveBeansByListKey("sensei.plugin.services",
      Object.class);
  ...
  public void test6GetFacet() {
    ...
    assertEquals("virtual_groupid_fixedlengthlongarray",
      pluginRegistry.getFacet("virtual_groupid_fixedlengthlongarray").getName());
  ...
  public void test7GetRuntimeFacet() {
    ...
    assertEquals("mockHandlerFactory", pluginRegistry.getRuntimeFacet("mockHandlerFactory")
        .getName());
    assertEquals("virtual_groupid_fixedlengthlongarray",
      pluginRegistry.getFacet("virtual_groupid_fixedlengthlongarray").getName());
