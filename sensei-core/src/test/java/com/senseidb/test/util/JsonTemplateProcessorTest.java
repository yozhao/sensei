...
public class JsonTemplateProcessorTest extends TestCase {
  ...
  public void setUp() throws Exception {
    senseiRequestStr = new String(IOUtils.toString(getClass().getClassLoader().getResourceAsStream(
      "json/sensei-request-with-templates.json")));
  ...
  public void testSubstituteTemplates() throws Exception {
    ...
    JSONObject substituted = (JSONObject) jsonTemplateProcessor.process(requestJson,
      jsonTemplateProcessor.getTemplates(requestJson));
    ...
    assertEquals("prefix_$substitutedParam_$$substitutedParam_suffix$$routeParam",
      substituted.getString("routeParam"));
