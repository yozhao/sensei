...
public class StabilityTest extends TestCase {
  ...
  public static class ConfigHolder {
      ...
      String brokerPort;
      String clientName;
      public ConfigHolder(String nodeId, String serverPort, String indexDirectory, String brokerPort, String clientName) {
        super();
        this.nodeId = nodeId;
    ...
    protected void setUp() throws Exception {
      File confDir1 = new File(SenseiStarter.class.getClassLoader().getResource("test-conf/node1").toURI());
      File confDir2 = new File(SenseiStarter.class.getClassLoader().getResource("test-conf/node2").toURI());
      for (int i = 0; i < 10; i++) {
        ...
        new ConfigHolder("" + i, String.valueOf(1228 + i), "sensei-index-test" + i, String.valueOf(11000 + i), "clientName").enhance(senseiConf);
      ...
      for (int i = 0; i < 10; i++) {
        Thread thread = new Thread() {
          ...
          public void run() {
            ...
            System.out.println(" Got the reposnse with time - " + (res.getInt("time")) + "and numHits = " + res.getInt("numhits"));
    ...
    public  JSONObject search(JSONObject req) throws Exception  {
      ...
      return  search(new URL("http://localhost:" + String.valueOf(11000 + ((currentlyShutdownServer + 5) % 10) + "/sensei")), req.toString());
    }
