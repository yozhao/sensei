...
public class PerfDriver {
  ...
  public static class PerfStats {
    ...
    public String toString() {
      ...
      buf.append("runtime: ").append(runTime).append(", qps: ").append(qps)
          .append(", numConsumed: ").append(numConsumed);
      return buf.toString();
    }
  }
  ...
  /*
   * sensei.gateway.kafka.zookeeperUrl=localhost:2181 sensei.gateway.kafka.consumerGroupId=1
   * sensei.gateway.kafka.topic=test sensei.gateway.kafka.timeout=3000
