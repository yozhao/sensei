...
class RabbitMQConfig {
    ...
    static class ConnectionConfig {
        ...
        @Override
        public String toString() {
            return "[host=" + this._host + ",port=" + this._port + ",heartbeat=" + this._heartbeat + ",timeout=" + this._timeout + "]";
        }
    }
    ...
    static class QueueConfig {
        ...
        QueueConfig(String name, boolean durable, boolean exclusive, boolean autodelete, String routingkey) {
            this._name = name;
            this._durable = durable;
        ...
        @Override
        public String toString() {
            return "[name=" + this._name + ",durable=" + this._durable + ",exclusive=" + this._exclusive + ",autodelete="
                    + this._autodelete + ",routingkey=" + this._routingkey + "]";
        }
    }
}
