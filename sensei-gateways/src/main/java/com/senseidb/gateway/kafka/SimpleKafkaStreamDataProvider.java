...
public class SimpleKafkaStreamDataProvider extends StreamDataProvider<JSONObject> {
  ...
  public SimpleKafkaStreamDataProvider(Comparator<String> versionComparator, String kafkaHost,
      int kafkaPort, int soTimeout, int batchSize, String topic, long startingOffset,
  ...
  @Override
  public void start() {
    _kafkaConsumer = new SimpleConsumer(_kafkaHost, _kafkaPort, _kafkaSoTimeout,
